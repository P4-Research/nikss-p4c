...
declare -a PROGRAMS=("scenarios/use-cases/p4/bng/bng.p4"
"scenarios/use-cases/p4/upf/upf.p4"
...
#declare -a PROGRAMS=("scenarios/use-cases/p4/l2l3_switch/l2l3_switch.p4")
#declare -a OPTIONS=("-mcpu=v1")
#declare -a P4ARGS=("--xdp")
