                ...
                inout psa_ingress_output_metadata_t ostd)
{
    ...
    DirectMeter(PSA_MeterType_t.BYTES) meter2;
    PSA_MeterColor_t color1 = PSA_MeterColor_t.RED;
    PSA_MeterColor_t color2 = PSA_MeterColor_t.RED;

    action do_forward(PortId_t egress_port) {
        color1 = meter1.execute();
        color2 = meter2.execute();

        if (color1 != PSA_MeterColor_t.RED && color1 != PSA_MeterColor_t.RED) {
